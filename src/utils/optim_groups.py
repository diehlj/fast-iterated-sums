# From: https://github.com/IdoAmos/not-from-scratch/blob/main/src/utils/optim_groups.py
    ...
    for mn, m in model.named_modules():
        for pn, p in m.named_parameters():
            if (
                ...
                or (pn.endswith("gamma") and not gamma_weight_decay)
            ):
